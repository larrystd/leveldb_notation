...
// Identifies a locked file. 文件锁对象
...
// A utility routine: write "data" to the named file. 讲字符序列写入文件
LEVELDB_EXPORT Status WriteStringToFile(Env* env, const Slice& data,
                                        const std::string& fname);

// A utility routine: read contents of named file into *data 读取文件内容到字符串
...
class LEVELDB_EXPORT EnvWrapper : public Env {  // Env包装，内部维护一个  Env* target_;指针
 public:  
